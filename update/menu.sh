...
echo -e " 💠$bd Client Name       ${color1} •${color3}$bd KangTuru"
...
[${green}03${NC}]${color1} •${color3}$bd ➤ PANEL L2TP & PPTP (${color2}menu-l2tp-pptp${color3})
[${green}04${NC}]${color1} •${color3}$bd ➤ PANEL VMESS & VLESS Section (${color2}menu-v2ray${color3})
[${green}05${NC}]${color1} •${color3}$bd ➤ PANEL SSR & SS (${color2}menu-ssr-ss${color3})
[${green}06${NC}]${color1} •${color3}$bd ➤ PANEL TROJAN (${color2}menu-trojan${color3})
[${green}07${NC}]${color1} •${color3}$bd ➤ MENU GANTI PORT SERVICE (${color2}menu-port${color3})
...
[${green}11${NC}]${color1} •${color3}$bd ➤ INFO AUTOSC (${color2}info${color3})

[${green}00${NC}]${color1} •${color3}$bd Back to exit Menu \033[1;32m<\033[1;33m<\033[1;31m<\033[1;31m"
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[41;1;39m                    ⇱ Remod By KangTuru ⇲                     \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e  ""
